...
mkdir (['/home/data/Projects/Zhen/', project, '/results/CPAC_zy', preprocessingDate, '_reorganized/noGSR/CWAS_98sub/mdmr3mmFWHM8followUp1'])
outputDir=['/home/data/Projects/Zhen/', project, '/results/CPAC_zy', preprocessingDate, '_reorganized/noGSR/CWAS_98sub/mdmr3mmFWHM8followUp1/'];
for i=1:numSub
    ...
    ROIDef={['/home/data/Projects/Zhen/Colibazzi/results/CPAC_zy2_22_14_reorganized/noGSR/CWAS_98sub/mdmr3mmFWHM8/cluster_mask_Group_text.nii']}
