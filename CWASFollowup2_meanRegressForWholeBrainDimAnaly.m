...
patientNum='39';
subID=load(['/home/data/Projects/Colibazzi/data/patients_', patientNum, 'sub.txt']);
...
for j=1:numMeasure
    measure=char(measureList{j})
       ...
       dataOutDir=['/home/data/Projects/', project, '/results/CPAC_zy', preprocessDate, '_reorganized/meanRegress/CWAS', measure, '/'];
    ...
    save([OutputName,'_MeanSTD_', patientNum, 'patients.mat'],'Mean_AllSub','Std_AllSub');
    ...
    outName=[dataOutDir, 'CWAS', measure, '_AllVolume_meanRegress_', patientNum, 'patients.nii'];
