...
GroupAnalysis=['/home/data/Projects/', project, '/results/CPAC_zy', preprocessDate, '_reorganized/groupAnalysis98subModel2/'];
...
for j=1:numMeasure
    ...
    FileName = {['/home/data/Projects/', project, '/results/CPAC_zy', preprocessDate, '_reorganized/meanRegress/', measure, '/', measure, '_AllVolume_meanRegress_98sub.nii']};
