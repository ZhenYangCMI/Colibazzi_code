...
% 1. define Dir
% for numerical ID
%subList=load('/home/data/Projects/Zhen/Colibazzi/data/patients_51sub.txt');
% for text ID
...
% 3. load covariates
modelSymptom=load(['/home/data/Projects/Zhen/', project, '/data/regression50patients.txt']);
modelOutcome=load(['/home/data/Projects/Zhen/', project, '/data/regression39patients.txt']);
...
%
%     glob=load(['/home/data/Projects/Zhen/workingMemory/results/CPAC_analysis_new/reorgnized/meanRegress/', measure, '/', measure, '_MeanSTD.mat'])
...
%         end
%     end
%     saveas(figure(j), ['/home/data/Projects/Zhen/workingMemory/figs/CPACpreprocessedNew/meanRegress/', measure, '_globalVariable_phenotype.png'])
% end
...
for j=1:numMeasure
    ...
    if strcmp(measure, 'CWASROI1') || strcmp(measure, 'CWASROI2')
        mask=['/home/data/Projects/Zhen/', project, '/masks/stdMask_98sub_compCor_100prct.nii'];
    else
    ...
    for k=1:length(modelist)
        ...
        if strcmp(modelName, 'modelSymptom')
            FileName = {['/home/data/Projects/Zhen/', project, '/results/CPAC_zy', preprocessDate, '_reorganized/meanRegress/', measure, '/', measure, '_AllVolume_meanRegress_50patients.nii']};
            model=modelSymptom;
        ...
        elseif strcmp(modelName, 'modelOutcomeRole')
            FileName = {['/home/data/Projects/Zhen/', project, '/results/CPAC_zy', preprocessDate, '_reorganized/meanRegress/', measure, '/', measure, '_AllVolume_meanRegress_39patients.nii']};
            model=modelOutcome;
