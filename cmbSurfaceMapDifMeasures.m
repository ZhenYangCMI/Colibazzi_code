...
for i=1:numRow
    ...
    elseif strcmp(row, 'SCAGroup4')
        measureList={'SCAlGpi', 'SCArGpi', 'SCAVTA'};
    elseif strcmp(row, 'SCAGroup5')
        measureList={'SCATHAL1', 'SCATHAL2', 'SCATHAL3'};
    elseif strcmp(row, 'SCAGroup6')
        measureList={'SCATHAL4', 'SCATHAL5', 'SCATHAL6'}; % SCATHAL7 will be added manually
    ...
    for j=1:numCol
        ...
        if strcmp(map, 'unthresh')
            ...
            if strcmp(col, 'CWAS')
                img{t,1} = {sprintf('%s/groupAnalysis/thresh_%s_Group_text.ni_SurfaceMap.jpg', OutputUpDir, col)};
            else
                img{t,1} = {sprintf('%s/groupAnalysis/thresh_%s_T1_Z_cmb_SurfaceMap.jpg', OutputUpDir, col)};
            end
        end
    end
end
...
OutJPGName=[OutputUpDir, '/groupAnalysis', map, '3.jpg'];
