...
BrainMaskFile=['/home/data/Projects/Zhen/Colibazzi/masks/meanStandFunMask_98sub_90prct.nii'];

MaskData=BrainMaskFile;
%1. compute the whole brain iFC
outputDir=['/home/data/Projects/Zhen/Colibazzi/results/CPAC_zy2_22_14_reorganized/noGSR/SCA_DCROI/'];
for i=1:numSub
    sub=num2str(subList(i))

    AllVolume=[dataDir, 'normFunImg_', sub, '.nii.gz'];

    ROIDef={['/home/data/Projects/Zhen/Colibazzi/masks/cluster_mask_DegreeCentrality_T1_Z_pos.nii']}
...
% 2. mean regression
effect='SCA_DCROI';
mkdir (['/home/data/Projects/Zhen/Colibazzi/results/CPAC_zy2_22_14_reorganized/meanRegress/SCA_DCROI/'])
dataOutDir=['/home/data/Projects/Zhen/Colibazzi/results/CPAC_zy2_22_14_reorganized/meanRegress/SCA_DCROI/'];
...
for i=1:length(subList)
    ...
    FileName = ['/home/data/Projects/Zhen/Colibazzi/results/CPAC_zy2_22_14_reorganized/noGSR/SCA_DCROI/FC_', sub, '.nii'];
