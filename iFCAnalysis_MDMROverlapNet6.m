...
effect = 'SCA_ThalROI_BasedOnMDMRoverlapNet6ClusterCMiFC'  %'SCA_MDMRoverlapNet6ClusterCM'
project='Colibazzi'
preprocessingDate='2_22_14';
dataDir=['/home/data/Projects/Zhen/Colibazzi/results/CPAC_zy2_22_14_reorganized/noGSR/FunImg/'];

subList=load(['/home/data/Projects/Zhen/', project, '/data/final/subClean_step2_98sub.txt']);
numSub=length(subList)

BrainMaskFile=['/home/data/Projects/Zhen/Colibazzi/masks/final/stdMask_', num2str(numSub), 'sub_3mm_noGSR_100prct.nii.gz'];

MaskData=BrainMaskFile;
%1. compute the whole brain iFC
mkdir (['/home/data/Projects/Zhen/Colibazzi/results/CPAC_zy2_22_14_reorganized/noGSR/', effect , '/'])
outputDir=['/home/data/Projects/Zhen/Colibazzi/results/CPAC_zy2_22_14_reorganized/noGSR/', effect, '/'];
for i=1:numSub
    ...
    %ROIDef={['/home/data/Projects/Zhen/Colibazzi/figs/final/MDMR/MDMROverlapNet6_clusterWithPeak_mask.nii']}
ROIDef={['/home/data/Projects/Zhen/Colibazzi/results/CPAC_zy2_22_14_reorganized/groupAnalysis98sub/SCA_MDMRoverlapNet6ClusterCM/easythresh/cluster_mask_SCA_MDMRoverlapNet6ClusterCM_T1_Z_pos.nii']}
...
% % 2. mean regression
% 
mkdir (['/home/data/Projects/Zhen/Colibazzi/results/CPAC_zy2_22_14_reorganized/meanRegress/', effect, '/'])
dataOutDir=['/home/data/Projects/Zhen/Colibazzi/results/CPAC_zy2_22_14_reorganized/meanRegress/', effect, '/'];
...
for i=1:length(subList)
    ...
    FileName = ['/home/data/Projects/Zhen/Colibazzi/results/CPAC_zy2_22_14_reorganized/noGSR/', effect, '/FC_', sub, '.nii'];
...
save([OutputName,'_MeanSTD_98sub.mat'],'Mean_AllSub','Std_AllSub');
...
outName=[dataOutDir, effect, '_AllVolume_meanRegress_98sub.nii'];
