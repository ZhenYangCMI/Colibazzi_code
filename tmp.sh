...
cmd1="fslmaths /home/data/Projects/Zhen/Colibazzi/results/CPAC_zy2_22_14_reorganized/noGSR/VMHC/VMHC_98sub.nii -bin -Tmean /home/data/Projects/Zhen/Colibazzi/results/CPAC_zy2_22_14_reorganized/noGSR/VMHC/VMHC_98sub_mask.nii"
echo $cmd1
eval $cmd1
done


3dcalc -a /home/data/Projects/Zhen/Colibazzi/figs/final/MDMR/thresh_Group_text.nii.gz -b /home/data/Projects/Zhen/Colibazzi/figs/final/MDMR/cluster_mask_Group_text_Yeo_net5rmd.nii -expr 'a*equals(b,6)' -prefix /home/data/Projects/Zhen/Colibazzi/figs/final/MDMR/thresh_Group_text_net6.nii
...
antsRegistration --collapse-linear-transforms-to-fixed-image-header 0 --collapse-output-transforms 0 --dimensionality 3 --interpolation Linear --output [ transform, transform_Warped.nii.gz ] --transform Rigid[ 0.1 ] --metric MI[ ${standard_template_2mm}, ${inputBrain}, 1, 32, Regular, 0.25 ] --convergence [ 1000x500x250x100, 1e-08, 10 ] --smoothing-sigmas 3.0x2.0x1.0x0.0 --shrink-factors 8x4x2x1 --use-histogram-matching 1 --transform Affine[ 0.1 ] --metric MI[ ${standard_template_2mm}, ${inputBrain}, 1, 32, Regular, 0.25 ] --convergence [ 1000x500x250x100, 1e-08, 10 ] --smoothing-sigmas 3.0x2.0x1.0x0.0 --shrink-factors 8x4x2x1 --use-histogram-matching 1 --transform SyN[ 0.1, 3.0, 0.0 ] --metric CC[ ${standard_template_2mm_withSkull}, ${inputImg}, 1, 4 ] --convergence [ 100x100x70x20, 1e-09, 15 ] --smoothing-sigmas 3.0x2.0x1.0x0.0 --shrink-factors 6x4x2x1 --use-histogram-matching 1 --winsorize-image-intensities [ 0.01, 0.99 ] 
